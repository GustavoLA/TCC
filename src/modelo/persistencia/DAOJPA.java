...
public abstract class DAOJPA<T, I> implements DAO<T, I> {
    ...
    public T save(T entity) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao salvar um elemento na base de dados.\n " + e.getMessage());
        }
        return saved;
    }
    ...
    public boolean remove(Class<T> classe, I pk) {
        ...
        try {
            ...
            getEntityManager().getTransaction().rollback();
            JOptionPane.showMessageDialog(null, "Erro remover elemento na base de dados\n " + e.getMessage());
        }
        return estado;
    }
